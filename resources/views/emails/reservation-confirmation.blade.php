...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="section">
                <h2>Totaalbedrag</h2>
                <p>Bedrag te betalen: <span class="total">€{{ number_format($reservation->total_price, 2, ',', '.') }}</span></p>
            ...
            <div class="bank-details">
                ...
                <p><strong>Referentie:</strong> Reservering #{{ $reservation->id }}</p>
            ...
            <div class="section">
                ...
                <ol>
                    <li>Maak de betaling over met referentienummer #{{ $reservation->id }}</li>
