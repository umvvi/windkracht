                    ...
                    <div>
                        ...
                        <p style="margin: 0;">
                            ...
                            @else
                                ...
                                @endphp
                                @if ($cancelledLessons === $totalLessons && $totalLessons > 0)
                        ...
                        <div style="display: grid; gap: 0.75rem;">
                            ...
                            <div style="background: #f9fafb; padding: 1rem; border-radius: 0.3rem; display: flex; justify-content: space-between; align-items: center;">
                                <div style="flex: 1;">
                                    ...
                                    <p style="font-size: 0.9rem; color: #666; margin: 0;">Instructeur: {{ $lesson->instructor->personalInformation?->full_name ?? 'Onbekend' }}</p>
