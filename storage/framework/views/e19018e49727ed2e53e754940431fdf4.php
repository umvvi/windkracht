...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Beste <?php echo e($lesson->reservation->customer->personalInformation->first_name ?? 'Klant'); ?>,</p>
            ...
            <div class="lesson-info">
                ...
                <p><strong>Datum & Tijd:</strong> <?php echo e($lesson->start_time->format('d-m-Y')); ?> van <?php echo e($lesson->start_time->format('H:i')); ?> tot <?php echo e($lesson->end_time->format('H:i')); ?></p>
                <p><strong>Locatie:</strong> <?php echo e($lesson->location->name); ?></p>
                <p><strong>Instructeur:</strong> <?php echo e($instructorName); ?></p>
            </div>

            <div class="section">
                <h2>Reden van Annulering</h2>
                <div class="reason-box">
                    <?php if($cancellationType === 'instructor_illness'): ?>
                    ...
                    <?php elseif($cancellationType === 'bad_weather'): ?>
                    ...
                    <?php else: ?>
                        <p><strong>Reden:</strong> <?php echo e(ucfirst($cancellationType)); ?></p>
                    <?php endif; ?>
                    <?php if($cancellationReason): ?>
                        <p><strong>Aanvullende informatie:</strong> <?php echo e($cancellationReason); ?></p>
                    <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH C:\Users\Comunicación\Desktop\school\resources\views/emails/lesson-cancellation.blade.php ENDPATH**/ ?>