...
<?php $__env->startSection('title', 'Windkracht-12 - Premium Kitesurfschool'); ?>
...
<div style="
    ...
    background: linear-gradient(rgba(3, 105, 161, 0.4), rgba(14, 165, 233, 0.4)),
                url('<?php echo e(asset('images/hero.png')); ?>') center/cover;
    display: flex;
    align-items: center;
...
<div style="margin-bottom: 4rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 2rem; max-width: 900px; margin: 0 auto;">
        ...
        " onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 16px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 8px rgba(0,0,0,0.08)'">
            <img src="<?php echo e(asset('images/beginner.png')); ?>" alt="Beginner Kitesurfing" style="width: 100%; height: 180px; object-fit: cover; display: block;">
            <div style="padding: 1.5rem;">
                ...
                <a href="<?php echo e(route('packages')); ?>" style="
                    display: block;
                    text-align: center;
        ...
        <div style="
            ...
            border: 1px solid #e5e7eb;
        " onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 16px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 8px rgba(0,0,0,0.08)'">
            <img src="<?php echo e(asset('images/advanced.png')); ?>" alt="Advanced Kitesurfing" style="width: 100%; height: 180px; object-fit: cover; display: block;">
            <div style="padding: 1.5rem;">
                <span style="
                    display: inline-block;
                    background: #fef3e8;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Comunicación\Desktop\school\resources\views/home.blade.php ENDPATH**/ ?>