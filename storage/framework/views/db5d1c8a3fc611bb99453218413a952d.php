            ...
            <div style="background: white; border-radius: 0.3rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); padding: 2rem; border-left: 4px solid #0369a1;">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0;">
                            <span style="padding: 0.4rem 0.8rem; border-radius: 0.3rem; font-size: 0.85rem; font-weight: 600; background: <?php echo e($reservation->status === 'confirmed' ? '#d1fae5' : '#fef3c7'); ?>; color: <?php echo e($reservation->status === 'confirmed' ? '#065f46' : '#92400e'); ?>;"><?php echo e(ucfirst($reservation->status)); ?></span>
                        </p>
                    </div>
                    <div>
                    ...
                    <?php if($reservation->lessons->count() > 0): ?>
                        <div style="display: grid; gap: 0.75rem;">
                            ...
                            <div style="background: #f9fafb; padding: 1rem; border-radius: 0.3rem; display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <?php if($lesson->status === 'scheduled' && $reservation->status === 'confirmed'): ?>
