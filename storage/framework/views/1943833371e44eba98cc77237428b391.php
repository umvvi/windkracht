    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <center>
                    <a href="<?php echo e($activationLink); ?>" class="button">Account Activeren</a>
                </center>

                <p style="color: #999; font-size: 12px;">Of kopieer deze link in je browser:</p>
                <p style="color: #0369a1; word-break: break-all; font-size: 12px;"><?php echo e($activationLink); ?></p>
            </div>
...
<?php /**PATH C:\Users\Comunicación\Desktop\school\resources\views/emails/activation.blade.php ENDPATH**/ ?>