...
<div style="max-width: 50rem; margin: 0 auto; margin-bottom: 3rem;">
    ...
    <div style="background: white; border-radius: 0.3rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); padding: 2rem;">
        <form action="<?php echo e(route('instructor.personal-info.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" id="bsn" name="bsn" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.3rem;" value="<?php echo e($personalInfo?->bsn); ?>">
                <?php $__errorArgs = ['bsn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Comunicación\Desktop\school\resources\views/instructor/personal-info.blade.php ENDPATH**/ ?>