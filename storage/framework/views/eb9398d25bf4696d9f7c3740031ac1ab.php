...
<div style="max-width: 50rem; margin: 0 auto; margin-bottom: 3rem;">
    ...
    <div style="background: white; border-radius: 0.3rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); padding: 2rem;">
        <form action="<?php echo e(route('owner.personal-info.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Comunicación\Desktop\school\resources\views/owner/personal-info.blade.php ENDPATH**/ ?>